...
// EventListener provides event handling capabilities for change events.
// It extends StreamEventListener with the ability to add additional listeners.
type EventListener[T domain.Entity] interface {
...
type InverseIndex[T domain.Entity] interface {
	StreamEventListener[T]
...
type InverseUniqueIndex[T domain.Entity] interface {
	StreamEventListener[T]
...
type SortedIndex[T domain.Entity] interface {
	StreamEventListener[T]
...
type SuffixIndex[T domain.Entity] interface {
	StreamEventListener[T]
...
type CacheWithEventListener[T domain.Entity] struct {
	Cache                Cache[T]
...
func NewCacheWithEventListener[T domain.Entity](
...
func buildIndexes[T domain.Entity](l *Listener[T], c Cache[T]) (
	inverseIndexes map[string]InverseIndex[T],
	inverseUniqueIndexes map[string]InverseUniqueIndex[T],
	sortedIndexes map[string]SortedIndex[T],
	suffixIndexes map[string]SuffixIndex[T],
